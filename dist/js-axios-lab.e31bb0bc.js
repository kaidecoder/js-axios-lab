  ...
  var _initialLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _axios.default)("https://api.thecatapi.com/v1/breeds");
        case 2:
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return (0, _axios.default)("https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=".concat(e.target.value));
                  case 2:
                    cats = _context.sent;
 ...
 */
function favorite(_x2) {
  return _favorite.apply(this, arguments);
}
function _favorite() {
  _favorite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(imgId) {
    var checkFavoriteResponse, deleteResponse, addResponse;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            url: "https://api.thecatapi.com/v1/favourites?image_id=".concat(imgId),
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              "x-api-key": "live_f442WpIpdmrvNYLgvqJ0J8GK7oIq3nbSIci46khmdQGVzslHpzf6QNYWy5vjyM9A"
            }
          });
        case 3:
          checkFavoriteResponse = _context4.sent;
          ...
          _context4.next = 8;
          return (0, _axios.default)({
            url: "https://api.thecatapi.com/v1/favourites/".concat(checkFavoriteResponse.data[0].id),
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
              "x-api-key": "live_f442WpIpdmrvNYLgvqJ0J8GK7oIq3nbSIci46khmdQGVzslHpzf6QNYWy5vjyM9A"
  ...
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        ...
        // Fetch favorites
        _context3.next = 4;
        return (0, _axios.default)("/favorites");
      case 4:
        favorites = _context3.sent;
        // Iterate through favorites and append each item to the carousel
        favorites.forEach(function (favorite) {
          var imgSrc = favorite.image.url; // Adjust this based on the structure of your favorite object
          var imgAlt = favorite.image_id; // You can customize the alt text
          var imgId = favorite.image.id; // Adjust this based on the structure of your favorite object
...
//# sourceMappingURL=/js-axios-lab.e31bb0bc.js.map